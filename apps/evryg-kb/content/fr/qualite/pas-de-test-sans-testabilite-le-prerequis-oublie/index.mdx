...
Une [fonction pure](/fr/fonctions-totales-et-partielles-la-promesse-du-type), qui ne dépend que de ses arguments et ne produit que sa valeur de retour, est trivialement testable : on lui fournit des entrées, on vérifie les sorties.
...
[TDD](/fr/tdd-une-discipline-de-design-pas-de-test) inverse la causalité habituelle : plutôt que de concevoir puis de se demander comment tester, on part du test et on laisse la testabilité guider le design.
