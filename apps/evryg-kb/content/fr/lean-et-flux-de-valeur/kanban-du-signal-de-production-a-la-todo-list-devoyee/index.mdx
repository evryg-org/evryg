...
Cette visualisation n'est pas décorative ; elle déclenche l'action. Le principe du [*jidoka*](/fr/lean-et-flux-de-valeur/detecter-les-erreurs-au-plus-tot-du-lean-au-shift-left) (arrêt au défaut) s'appuie sur cette visibilité : un problème caché est un problème qui s'aggrave.
