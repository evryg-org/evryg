...
Investir dans la détection précoce, c'est investir dans la [testabilité](/fr/ingenierie-logicielle-avancee/qualite-et-tests/pas-de-test-sans-testabilite-le-prerequis-oublie), la modularité, la qualité du typage : des propriétés qui améliorent le design bien au-delà de leur utilité pour les tests.
