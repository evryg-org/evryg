...
Un ADT se construit par composition de [deux opérations fondamentales](/fr/ingenierie-logicielle-avancee/algebre-des-types-produits-et-sommes) :
...
Plutôt qu'un `Order` avec des champs optionnels dont la validité dépend d'un champ `status`, on modélise [une machine à état explicite](/fr/ingenierie-logicielle-avancee/machines-a-etat-et-aggregats-en-ddd) :
