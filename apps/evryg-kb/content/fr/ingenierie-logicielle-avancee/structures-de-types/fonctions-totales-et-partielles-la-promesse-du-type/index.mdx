---
pageType: article
sidebarTitle: Fonctions totales et partielles
tags: [type-safety, error-handling, correctness, type-theory, domain-modeling, software-design]
---
...
L'article [Parse, Don't Validate](/fr/ingenierie-logicielle-avancee/design-par-les-types/parse-dont-validate) d'Alexis King privilégie la première approche ; les langages fonctionnels traditionnels emploient souvent la seconde via `Option` ou `Either`. Chez evryg, nous parlons plutôt de « contraindre en amont » (au niveau du type des arguments de la fonction - le domaine) ou « d'élargir en aval » (au niveau du type de retour - le codomaine).

## La dimension logique : Curry-Howard

Du point de vue de [Curry-Howard](/fr/ingenierie-logicielle-avancee/types-et-logique/la-correspondance-de-curry-howard-lien-entre-programmes-et-preuves), cette distinction entre fonction totale et fonction partielle prend une dimension logique.
