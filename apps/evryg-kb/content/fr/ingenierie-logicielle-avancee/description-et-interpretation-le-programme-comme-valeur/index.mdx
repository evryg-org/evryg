...
- **[Testabilité](/fr/ingenierie-logicielle-avancee/pas-de-test-sans-testabilite-le-prerequis-oublie)** : on peut inspecter la description sans l'exécuter, ou fournir un interpréteur de test qui simule les effets
