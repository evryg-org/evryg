...
tags: [type-safety, validation, domain-modeling, error-handling, architecture, correctness, parsing]
---
...
Cette philosophie s'inscrit dans la continuité directe de [Make Illegal States Unrepresentable](/fr/ingenierie-logicielle-avancee/design-par-les-types/make-illegal-states-unrepresentable) de Yaron Minsky, mais en adresse le versant dynamique.
