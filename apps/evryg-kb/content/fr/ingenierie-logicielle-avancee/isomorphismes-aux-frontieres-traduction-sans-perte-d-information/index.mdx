...
L'approche [Parse, don't validate](/fr/parse-dont-validate) s'inscrit naturellement dans ce cadre.
...
A noter qu'une telle propriété de round-trip est utile en [property-based testing](/fr/property-based-testing-puissance-et-limites).
