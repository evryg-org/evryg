...
L'approche [Parse, don't validate](/fr/ingenierie-logicielle-avancee/parse-dont-validate) s'inscrit naturellement dans ce cadre.
...
A noter qu'une telle propriété de round-trip est utile en [property-based testing](/fr/ingenierie-logicielle-avancee/property-based-testing-puissance-et-limites).
