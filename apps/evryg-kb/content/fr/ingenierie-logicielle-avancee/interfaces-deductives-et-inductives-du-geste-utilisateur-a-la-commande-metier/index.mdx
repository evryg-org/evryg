...
Cette commande traverse le système avec sa sémantique intacte. Le backend n'a plus rien à déduire : il reçoit directement un ordre clair qu'il peut [valider](/fr/parse-dont-validate), exécuter et journaliser.
...
5. L'[agrégat](/fr/machines-a-etat-et-aggregats-en-ddd) implémente une méthode `approve()`
...
- **Côté écriture** : chaque commande peut porter [exactement les données nécessaires](/fr/make-illegal-states-unrepresentable) à sa validation, ni plus ni moins
