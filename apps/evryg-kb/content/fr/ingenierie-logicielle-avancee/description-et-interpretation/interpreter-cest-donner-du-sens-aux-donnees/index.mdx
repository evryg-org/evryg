---
pageType: article
sidebarTitle: Interpréter, donner du sens
tags: [domain-specific-languages, effect-systems, abstraction, architecture, software-design, declarative-programming]
---
...
En programmation fonctionnelle, cette idée prend une forme particulièrement explicite avec le pattern [program as value](/fr/ingenierie-logicielle-avancee/description-et-interpretation/description-et-interpretation-le-programme-comme-valeur).
...
Un DSL produit des données : un AST dans l'[encodage initial](/fr/ingenierie-logicielle-avancee/description-et-interpretation/encodages-initial-et-final-deux-philosophies-dembedding), des fonctions polymorphes dans l'encodage final ; tout ceci ne représentant que des intentions, sans les exécuter.
