...
tags: [testing, property-based-testing, specifications]
---
...
Le générateur explore l'espace des entrées de manière bien plus exhaustive que notre imagination.
...
Un tableau de 500 éléments qui fait échouer un tri devient peut-être un tableau de 3 éléments avec une configuration précise. Cette minimisation transforme un échec obscur en un cas de test lisible et debuggable.
