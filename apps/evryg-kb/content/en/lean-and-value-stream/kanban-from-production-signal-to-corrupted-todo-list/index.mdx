...
This visualization is not decorative; it triggers action. The [*jidoka*](/en/detect-errors-early-from-lean-to-shift-left) principle (stop at defect) relies on this visibility: a hidden problem is a problem that worsens.
