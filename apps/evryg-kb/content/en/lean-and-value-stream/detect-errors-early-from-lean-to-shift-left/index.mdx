...
- Forget to handle a case in [pattern matching](/en/algebraic-data-types-precision-and-expressiveness)? Compilation error.
...
Investing in early detection means investing in [testability](/en/no-test-without-testability-the-forgotten-prerequisite), modularity, typing quality: properties that improve design well beyond their usefulness for testing.
