...
Investing in early detection means investing in [testability](/en/advanced-software-engineering/no-test-without-testability-the-forgotten-prerequisite), modularity, typing quality: properties that improve design well beyond their usefulness for testing.
