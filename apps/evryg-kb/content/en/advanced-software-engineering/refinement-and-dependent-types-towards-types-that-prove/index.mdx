...
We go beyond simple [Make Illegal States Unrepresentable](/en/advanced-software-engineering/make-illegal-states-unrepresentable) to reach "Make Illegal Operations Untypeable": programs that compile are correct by construction, at least with respect to the encoded properties.
