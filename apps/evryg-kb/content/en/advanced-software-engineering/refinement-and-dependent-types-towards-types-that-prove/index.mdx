...
We go beyond simple [Make Illegal States Unrepresentable](/en/make-illegal-states-unrepresentable) to reach "Make Illegal Operations Untypeable": programs that compile are correct by construction, at least with respect to the encoded properties.
