...
A program source, after parsing, is merely an [abstract syntax tree](/en/advanced-software-engineering/algebraic-data-types-precision-and-expressiveness): a data structure like any other, with nodes, branches, and leaves.

Lisp made this equivalence explicit from its origins: code is a list, lists are data, and `eval` [transforms data into executable behavior](/en/advanced-software-engineering/description-and-interpretation-program-as-value). Macros, metaprograms, [compilers](/en/advanced-software-engineering/initial-and-final-encodings-two-embedding-philosophies): all manipulate code as data that can be inspected, transformed, and generated.
