...
A program source, after parsing, is merely an [abstract syntax tree](/en/algebraic-data-types-precision-and-expressiveness): a data structure like any other, with nodes, branches, and leaves.

Lisp made this equivalence explicit from its origins: code is a list, lists are data, and `eval` [transforms data into executable behavior](/en/description-and-interpretation-program-as-value). Macros, metaprograms, [compilers](/en/initial-and-final-encodings-two-embedding-philosophies): all manipulate code as data that can be inspected, transformed, and generated.
