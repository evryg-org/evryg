...
pageType: article
sidebarTitle: "Safe Refactoring with PBT"
tags: [property-based-testing, refactoring, testing, legacy-code, correctness]
---
...
The traditional approach is to write unit tests covering known cases, but how do we ensure we haven't omitted a case? [Property-based testing](/en/advanced-software-engineering/quality-and-testing/property-based-testing-power-and-limits) offers a much stronger guarantee: verifying that $f(x) = f'(x)$ for thousands of randomly generated values.
