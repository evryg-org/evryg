...
pageType: article
sidebarTitle: "TDD and Emergent Design"
tags: [test-driven-development, testing, software-design, refactoring, architecture, emergent-design]
---
...
The test becomes an exacting first client that shapes the [public interface](/en/advanced-software-engineering/advanced-patterns/deductive-and-inductive-interfaces-from-user-gesture-to-business-command).
