...
The [Parse, don't validate](/en/parse-dont-validate) approach naturally fits within this framework.
...
Note that such a round-trip property is useful in [property-based testing](/en/property-based-testing-power-and-limits).
