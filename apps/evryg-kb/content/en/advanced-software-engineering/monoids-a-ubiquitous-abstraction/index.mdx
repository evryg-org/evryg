...
This uniformity eliminates an entire class of bugs related to edge cases. The monoid transforms absence into trivial presence. See also our article on [total and partial functions](/en/total-and-partial-functions-the-type-promise).
