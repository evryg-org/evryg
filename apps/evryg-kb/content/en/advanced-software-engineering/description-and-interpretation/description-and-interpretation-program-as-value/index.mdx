...
pageType: article
sidebarTitle: "Program as Value"
tags: [declarative-programming, domain-specific-languages, composition, architecture, effect-systems, testing]
---
...
- **[Testability](/en/advanced-software-engineering/quality-and-testing/no-test-without-testability-the-forgotten-prerequisite)**: we can inspect the description without executing it, or provide a test interpreter that simulates effects
