...
The test becomes an exacting first client that shapes the [public interface](/en/advanced-software-engineering/deductive-and-inductive-interfaces-from-user-gesture-to-business-command).
