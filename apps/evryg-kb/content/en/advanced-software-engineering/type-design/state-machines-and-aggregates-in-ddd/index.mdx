...
pageType: article
sidebarTitle: "State Machines and DDD"
tags: [ddd, state-machines, domain-modeling, architecture]
---
...
This correspondence allows applying the [Make Illegal States Unrepresentable](/en/advanced-software-engineering/type-design/make-illegal-states-unrepresentable) principle with fine granularity.

Rather than a monolithic aggregate with optional fields whose presence depends on the current state, we can model each state as a distinct variant of a [sum type](/en/advanced-software-engineering/type-structures/type-algebra-products-and-sums), carrying exactly the relevant data:
