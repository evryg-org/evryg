...
pageType: article
tags: [type-safety, architecture, domain-modeling, testing, serialization, correctness]
---
...
The [Parse, don't validate](/en/advanced-software-engineering/type-design/parse-dont-validate) approach naturally fits within this framework.
...
Note that such a round-trip property is useful in [property-based testing](/en/advanced-software-engineering/quality-and-testing/property-based-testing-power-and-limits). These tests are cheap insurance: detecting data loss in CI costs a few minutes of fixing, detecting it in production costs hours of investigation, data to reconcile, sometimes customer compensation.
