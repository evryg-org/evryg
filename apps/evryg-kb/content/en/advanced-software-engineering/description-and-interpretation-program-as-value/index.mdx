...
- **[Testability](/en/advanced-software-engineering/no-test-without-testability-the-forgotten-prerequisite)**: we can inspect the description without executing it, or provide a test interpreter that simulates effects
